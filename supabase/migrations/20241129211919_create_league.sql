...
CREATE OR REPLACE FUNCTION junowot.fn_touch_updated_at() 
RETURNS trigger
LANGUAGE plpgsql
AS $func$
begin
...
create or replace trigger tg_league_updated before
update
    on
    junowot.league for each row execute function junowot.fn_touch_updated_at();
